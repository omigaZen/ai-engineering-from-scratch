...
> 每次预测误差都可分为偏差、方差与噪声三部分，而我们能控制的只有前两项。

**类型:** Learn  
**语言:** Python  
**先修:** 第 2 期第 1-9 课（机器学习基础、回归、分类、评估）  
**时长:** ~75 分钟

## 学习目标

- 推导期望误差的偏差-方差分解并解释不可约噪声。
- 区分高偏差与高方差模型行为，理解它们在验证曲线中的表现。
- 比较模型复杂度、样本量与正则化之间的关系。
- 用实例判断误差来源，并给出“更简单”或“更稳健”改进方向。
