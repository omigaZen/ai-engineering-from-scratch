...
| SMOTE | “合成过采样” | 在现有少数类样本和其 k 个最近少数类邻居之间插值，生成新的少数类样本 |
...
| AUPRC | “PR 曲线下面积” | 把精确率-召回率曲线汇总成一个数；在类别严重不平衡时比 AUC-ROC 更有信息量 |
| Matthews Correlation Coefficient | “平衡指标” | 一个预测标签与真实标签之间的相关性指标，只有两个类别都表现好时分数才会高 |
